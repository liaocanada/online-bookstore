const configDefaults = {
  ...
  LOGIN_URL: 'https://davidliaobookstore.auth.us-east-1.amazoncognito.com/login?response_type=token&client_id=3gv2ehl5eo84cijqql7sgquoc4&redirect_uri=http://localhost:3000/callback',
};
