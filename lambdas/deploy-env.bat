...
cls
aws lambda update-function-configuration --function-name %toDeploy% --environment "Variables={DB_HOST=%HOST%, DB_DATABASE=%DATABASE%, DB_USER="%USERNAME%", DB_PASSWORD="%PASSWORD%"}"
